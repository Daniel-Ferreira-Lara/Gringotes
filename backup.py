        ...
        match var:
            ...
            case 2:
                ...
                if resposta[2] == "1":                  
                    ...
                    return orientacao,var
            # case 3:
            #     pergunta = "qual o código de rastreio da conta {}".format(self.contaUsuario)
            #     resposta = db_chainDirect.run(pergunta)
            #     cod_rast = resposta.strip("[]()'").split(',')[0].rstrip("'")
            #     self.codRast = cod_rast
            #     var = var +1
            #     orientacao = estagio_conversa_dict["5"]
            #     return orientacao,var
...
def main():
    ...
    while True:
        ...
        print("var:",var,"orientacao",orientacao)    
        ...
        if var!=0:
            orientacao = "verifique se na frase {input} o usuário quer mais ajuda.Se sim diga apenas sim. Se não diga apenas não"
            alice_output = alice.atendimento(user_input,orientacao)
            print("\n alice turn =>",alice_output) 
            alice.alice_step(alice_output)
            if alice_output == "não":
        ...
        elif label == "cancel_transfer":
            orientacao = "bla bla bla"
            print(orientacao)
main()